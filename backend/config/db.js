...
const connectDB = async () => {
  ...
  if (!uri) {
    ...
    console.error('  Atlas: mongodb+srv://f223873:YOUR_PASSWORD@neurohire.nftaz6m.mongodb.net/neurohire?retryWrites=true&w=majority');
    process.exit(1);
  }
  ...
  if (!isMongoUri || uri === '5000' || uri === process.env.PORT) {
    ...
    console.error('  MONGO_URI=mongodb+srv://f223873:YOUR_PASSWORD@neurohire.nftaz6m.mongodb.net/neurohire?retryWrites=true&w=majority');
    process.exit(1);
  }
  try {
